...
export function ReportPanel({ report, previousReport, onNewTests }) {
  ...
  const {
    url, timestamp, duration_ms, testsRun, summary,
    vitals, sourceAudit, bugs, sessionId,
    healthScore, grade,
  } = report;
    ...
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-x-4 gap-y-1 text-sm text-[#7B8794]">
              ...
              <span>{testsRun} tests executed</span>
              <span className="hidden sm:inline">|</span>
              <span>{(duration_ms / 1000).toFixed(1)}s duration</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        {[
          ...
          { label: 'Duration', value: `${(duration_ms / 1000).toFixed(1)}s`, accent: '#7B8794' },
